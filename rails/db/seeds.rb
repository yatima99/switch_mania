ActiveRecord::Base.transaction do
  ...
  15.times do |i|
    Post.create!(title: "テストタイトル1-#{i}", content: "テスト本文1-#{i}", image: "./public/test.png", status: :published, user: user1)
    Post.create!(title: "テストタイトル2-#{i}", content: "テスト本文2-#{i}", image: "./public/hhkb.jpg", status: :published, user: user2)
  end
end
